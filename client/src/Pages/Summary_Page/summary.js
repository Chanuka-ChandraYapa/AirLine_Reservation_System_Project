...
export function Passenger() {
  const exportPDF = () => {
    ...
    const data = passenger_List.map(elt=> [elt.passenger_ID, elt.first_name, elt.last_name, elt.passport_number]);
...
export function Booking(){
  ...
  const exportPDF = () => {
    ...
    const title = "Booking details of the Flights from " + startDate2 + " to " + endDate2;
    const headers = [["Passenger Type", "Number of bookings"]];
  
    const data =[["Guest Passenger",guestPassengerCount],["Gold Passenger",goldPassengerCount],["Frequent Passenger",frequentPassengerCount]]
            ...
            {isShown3 && (
              ...
              <TableBody>
                  ...
                  <TableRow
                    ...
                    sx={{ '&:last-child td, &:last-child th': { border: 0 } }}
                  >
                    <TableCell component="th" scope="row"> Guest Passenger </TableCell>
                  ...
                  <TableRow
                    ...
                    sx={{ '&:last-child td, &:last-child th': { border: 0 } }}
                  >
                    <TableCell component="th" scope="row"> Gold Passenger </TableCell>
                  ...
                  <TableRow
                    ...
                    sx={{ '&:last-child td, &:last-child th': { border: 0 } }}
                  >
                    <TableCell component="th" scope="row"> Frequent Passenger </TableCell>
                    <TableCell align="right"> {frequentPassengerCount} </TableCell>
                  </TableRow>
              </TableBody>
            </Table>
            )}
