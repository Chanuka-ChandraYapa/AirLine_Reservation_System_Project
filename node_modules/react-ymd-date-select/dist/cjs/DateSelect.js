...
const use_date_select_1 = require("./use-date-select");
// eslint-disable-next-line @typescript-eslint/no-explicit-any
const DateSelect = react_1.default.forwardRef((props, ref) => {
    ...
    const dateSelectProps = (0, use_date_select_1.useDateSelect)(value, onChange, opts);
